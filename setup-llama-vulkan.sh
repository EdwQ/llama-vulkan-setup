...
echo "   mkdir -p ~/llama-models"
echo "   cd ~/llama-models"
echo "   wget https://www.modelscope.cn/unsloth/Qwen3.6-27B-GGUF/resolve/main/Qwen3.6-27B-Instruct-Q4_K_M.gguf"
echo ""
echo "3. 命令行交互模式:"
...
echo "- 模型下载：https://www.modelscope.cn/models/unsloth/Qwen3.6-27B-GGUF"
echo ""
